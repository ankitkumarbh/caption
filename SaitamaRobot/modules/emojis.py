...
@user_admin
@run_async
def kills(update: Update, context: CallbackContext):
    msg = update.effective_message.reply_text('🔫') 
    for x in range(EDIT_TIMES):
...
KILL_HANDLER = DisableAbleCommandHandler("kills",kills)
...
__mod_name__ = "EMOJIS"
__command_list__ = ["love", "hack", "bombs", "moonanimation", "clockanimation", "earthanimation", "blockanimation", "kills"]
